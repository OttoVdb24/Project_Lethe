...
def Planningsscherm_maken(overlay,planningvlak,PlanRect_Color,PlanRect,Font_PlanTitel,PlanRect_TitelColor,PlanRect1,Font_PlanKop1,Font_PlanKop2,PlanRect2_1,
                          ...
                          HighlightRect2,Klok2_U,Klok2_M,klokvlak,KleurRects, KleurKiezerActive,KleurkiezerRect):
