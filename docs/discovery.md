...
>Wat geeft er stress en wat de voornaamste triggers hiervoor?
...
In een tweede aspect van het onderzoek bekenen we de markt van dichterbij.
>Wat bestaat er al? 
...
### Materiaal & methoden
#### User interviews (N=3)
Het onderzoek maakte gebruik van diepte-interviews als kwalitatieve onderzoeks methode om inzicht te verkrijgen in de huidige gang van zaken binnen gezinnen. Aan de hand van gerichte, open vragen werden ervaringen, percepties in het dagelijkse leven van de deelnemers in kaart gebracht. 
...
>- Kan het synchroniseren met online agenda's?
>- ...
  * [Protocol benchmark](./Protocol%20benchmarking.pdf)

### Resultaten

#### User interviews
De gezinnen die werden geinterviewd hadden kinderen tussen de 1 en 5 jaar oud.
Ze ervaarden stuk voor stuk stress door het opvoeden. De stress ontwikkeld zich voornamelijk 's ochtends. Alles op tijd klaar krijgen is op zich al moeielijk. Daar bovenop komt nog eens de onvoorspelbaarheid van een jong kind. 
...
Op de vraag, 'wat moet een nieuw product vooral zijn?' kwamen volgende antwoorden:
...
**Algemeen** 
kunnen we stellen dat geen enkel product uit deze benchmark echt een oplossing bied voor dit probleem. De producten zijn :
> Te duur
Vragen te veel tijd
Niet gericht op kinderen
...
|-------|-----|---|
|1.1|Handelingen met het product moeten 's ochtends kunnen gebeuren zonder dat het tijd kost. | user interview & benchmark|
|2.1| Het product moet kinderen in staat stellen om zelfstandig hun zakken te maken| user interview|
|3.1| Het product moet binnen het budget van een gemiddeld gezin passen| user interview
