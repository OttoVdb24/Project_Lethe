...
* kinderen verantwoordelijkheid laat opnemen voor hun eigen tas [DR 3.5];
* rust en voorspelbaarheid creëert tijdens drukke ochtendmomenten [DR 3.6];
* gebruikmaakt van externe triggers, zodat ouders niet voortdurend hoeven te herinneren aan taken [DR 2.3];
* aansluit bij de leefwereld van kinderen door gebruik te maken van visuele en interactieve begeleiding [DR 2.5, DR 3.4];
* zelfstandigheid en executieve vaardigheden stimuleert door kinderen actief te betrekken bij planning en voorbereiding [3.4, DR 3.5, DR 3.7];
...
* het product kan gepersonaliseerd worden naar de voorkeuren en leefwereld van het kind  [DR 3.3, DR 5.5, DR 5.6]
</p>
