...
De afmetingen van de handvaten werden bepaald aan de hand van het principe **design for the tall**. Als referentiemaat werd de handgrootte van een volwassene gehanteerd, zodat zowel ouders als opgroeiende kinderen de kapstok zonder moeite kunnen dragen. Dit resulteerde in een minimale **breedte van 94 mm.**

*Ik moet de foto nog annoteren het komt er aan hahah*

<p align="left">
  <img src="../img/Vorm_Exploded.png" width="80%">
</p>
